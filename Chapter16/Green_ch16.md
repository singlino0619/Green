...
- GMMアプローチ
	-　基本的な概念は，母集団のモーメントを標本空間のモーメントを用いて推定する方法である．
   	- 16.7式と16.8式を離散化する．
   	- 確定的な被積分関数の伊藤積分は平均0，分散
   	$$
...
- 利点は、キャリブレーションした近くの期間のボラを反映したボラティリティになっていること
...
##### Spot commodities
- スポットコモディティは，イメージとしては株やスポットFXと同じように，スポットの資産として取引される.
